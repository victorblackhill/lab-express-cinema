...
const seedMovies = async function (moviesToInsert){

    try{
        await movieModel.deleteMany();
        const dbSuccess = await movieModel.create(moviesToInsert)
        console.log(`seed completed ${dbSuccess.length} movies addesd`)
